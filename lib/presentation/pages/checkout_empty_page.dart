...
class CheckoutEmptyPage extends StatefulWidget {
  const CheckoutEmptyPage({super.key});

  @override
  State<CheckoutEmptyPage> createState() => _CheckoutEmptyPageState();
}

class _CheckoutEmptyPageState extends State<CheckoutEmptyPage> {
  @override
      ...
      appBar: AppBar(
        leading: Padding(padding: EdgeInsets.only(left: 20),
          child: GestureDetector(
            onTap: () {
              Navigator.push(context, MaterialPageRoute(builder: (context) => CheckoutPage())); //перехд на окно корзины с данными
            },
                          ...
                          child: Column(
                            children: [
                              Row(
                                mainAxisAlignment: MainAxisAlignment.start,
                                children: [
                                  Text('*******@*****.***', style: GoogleFonts.roboto(fontSize: 14, color: MyColors.textColor,)),
                                ],
                              ),
                              SizedBox(height: 4,),
                              Row(
                          ...
                          child: Column(
                            children: [
                              Row(
                                mainAxisAlignment: MainAxisAlignment.start,
                                children: [
                                  Text('Добавить', style: GoogleFonts.roboto(fontSize: 14, color: MyColors.textColor,)),
                                ],
                              ),
                              SizedBox(height: 4,),
                              Row(
                                mainAxisAlignment: MainAxisAlignment.start,
                                children: [
                                  Text('**** ****', style: GoogleFonts.roboto(fontSize: 12, color: MyColors.hintColor,)),
                                ],
                              )
                            ],
                          ),
